...
#' @param ... Additional named attributes that will be passed to \code{\link{seasonder_initializeAttributesSeaSondeAPM}}.
#'
#' @return A SeaSondeAPM object containing a complex matrix with class attribute 'SeaSondeAPM' and
...
#' 1. Validates the \code{calibration_matrix} with code{\link{seasonder_validateCalibrationMatrixSeaSondeAPM}}.
...
#' 4. Sets the object's class to 'SeaSondeAPM'.
#'
...
#' @importFrom magrittr %>% %<>%
#' @export
seasonder_createSeaSondeAPM <- function(calibration_matrix = matrix(complex(real=NA_real_, imaginary=NA_real_), nrow = 2, ncol = 0),...) {

  # Validate calibration matrix
  seasonder_validateCalibrationMatrixSeaSondeAPM(calibration_matrix)

  rownames(calibration_matrix) <- c("A13", "A23")

  # Initialize attributes
  attributes_list <- seasonder_initializeAttributesSeaSondeAPM(calibration_matrix,...)
  ...
  calibration_matrix <- attributes_list %>% purrr::reduce2(names(attributes_list),\(cal_matrix_so_far,attribute,attribute_name){
    setter_fun <- get(glue::glue("seasonder_set_SeaSondeAPM_{attribute_name}"))
...
#' Initialize Attributes for a SeaSondeAPM Object
#'
...
#'
#' @return A list containing initialized attributes for a SeaSondeAPM object.
#'
#' @details
...
#' @importFrom magrittr %<>%
#' @export
seasonder_initializeAttributesSeaSondeAPM <- function(calibration_matrix,...) {
...
#' Validate Calibration Matrix for a SeaSondeAPM Object
#'
...
#'
#' @export
seasonder_validateCalibrationMatrixSeaSondeAPM <- function(matrix) {
...
#' Validate Attributes for a SeaSondeAPM Object
#'
#' This function validates the attributes of a given SeaSondeAPM object to ensure they meet the required specifications.
#'
#' @param seasonde_apm_obj A SeaSondeAPM object whose attributes are to be validated.
#'
...
#'
#'@export
seasonder_validateAttributesSeaSondeAPM <- function(seasonde_apm_obj) {
  validate_SeaSondeAPM_quality_matrix(attributes(seasonde_apm_obj)$quality_matrix,seasonde_apm_obj)
  validate_SeaSondeAPM_BEAR(attributes(seasonde_apm_obj)$BEAR,seasonde_apm_obj)
  validate_SeaSondeAPM_Type(attributes(seasonde_apm_obj)$Type)
  validate_SeaSondeAPM_Creator(attributes(seasonde_apm_obj)$Creator)
  validate_SeaSondeAPM_SiteName(attributes(seasonde_apm_obj)$SiteName)
  validate_SeaSondeAPM_SiteOrigin(attributes(seasonde_apm_obj)$SiteOrigin)
  validate_SeaSondeAPM_FileName(attributes(seasonde_apm_obj)$FileName)
  validate_SeaSondeAPM_CreateTimeStamp(attributes(seasonde_apm_obj)$CreateTimeStamp)
  validate_SeaSondeAPM_ProcessingSteps(attributes(seasonde_apm_obj)$ProcessingSteps)
  validate_SeaSondeAPM_AmplitudeFactors(attributes(seasonde_apm_obj)$AmplitudeFactors)
  validate_SeaSondeAPM_AntennaBearing(attributes(seasonde_apm_obj)$AntennaBearing)
  validate_SeaSondeAPM_StationCode(attributes(seasonde_apm_obj)$StationCode)
  validate_SeaSondeAPM_BearingResolution(attributes(seasonde_apm_obj)$BearingResolution)
  validate_SeaSondeAPM_Smoothing(attributes(seasonde_apm_obj)$Smoothing)
  validate_SeaSondeAPM_CommentLine(attributes(seasonde_apm_obj)$CommentLine)
  validate_SeaSondeAPM_FileID(attributes(seasonde_apm_obj)$FileID)
  validate_SeaSondeAPM_PhaseCorrections(attributes(seasonde_apm_obj)$PhaseCorrections)

  return(TRUE)
}

#' Validate quality_matrix Attribute for a SeaSondeAPM Object
#'
...
#' @param seasonde_apm_obj The SeaSondeAPM object for compatibility check.
...
#' Validate BEAR Attribute for a SeaSondeAPM Object
#'
...
#' Validate Type Attribute for a SeaSondeAPM Object
#'
...
#' Validate Creator Attribute for a SeaSondeAPM Object
#'
...
#' Validate SiteName Attribute for a SeaSondeAPM Object
#'
...
#' Validate SiteOrigin Attribute for a SeaSondeAPM Object
#'
...
#' @return Returns TRUE if the validation passes.
validate_SeaSondeAPM_SiteOrigin <- function(site_origin) {
...
#' Validate FileName Attribute for a SeaSondeAPM Object
#'
...
#' Validate CreateTimeStamp Attribute for a SeaSondeAPM Object
#'
...
#' Validate ProcessingSteps Attribute for a SeaSondeAPM Object
#'
...
#' Validate AmplitudeFactors Attribute for a SeaSondeAPM Object
#'
...
#' Validate AntennaBearing Attribute for a SeaSondeAPM Object
#'
...
#' Validate StationCode Attribute for a SeaSondeAPM Object
#'
...
#' Validate BearingResolution Attribute for a SeaSondeAPM Object
#'
...
#' Validate Smoothing Attribute for a SeaSondeAPM Object
#'
...
#' Validate CommentLine Attribute for a SeaSondeAPM Object
#'
...
#' Validate FileID Attribute for a SeaSondeAPM Object
#'
...
#' Validate PhaseCorrections Attribute for a SeaSondeAPM Object
#'
...
#' @export
seasonder_get_SeaSondeAPM_quality_matrix <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$quality_matrix)
}

# Setter for quality_matrix
#' @export
seasonder_set_SeaSondeAPM_quality_matrix <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_quality_matrix(new_value,seasonde_apm_obj)
...
# Getter for BEAR
#' @export
seasonder_get_SeaSondeAPM_BEAR <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$BEAR)
}

# Setter for BEAR
#' @export
seasonder_set_SeaSondeAPM_BEAR <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_BEAR(new_value,seasonde_apm_obj)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_PhaseCorrections <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$PhaseCorrections)
}

# Setter for PhaseCorrections
#' @export
seasonder_set_SeaSondeAPM_PhaseCorrections <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_PhaseCorrections(new_value)
  modified_obj <- seasonde_apm_obj
...
# Getter for Type
#' @export
seasonder_get_SeaSondeAPM_Type <- function(seasonde_apm_obj) {
...
# Setter for Type
#' @export
seasonder_set_SeaSondeAPM_Type <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_Type(new_value)
  modified_obj <- seasonde_apm_obj
...
# Getter for Creator
#' @export
seasonder_get_SeaSondeAPM_Creator <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$Creator)
}

# Setter for Creator
#' @export
seasonder_set_SeaSondeAPM_Creator <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_Creator(new_value)
  modified_obj <- seasonde_apm_obj
...
# Getter for SiteName
#' @export
seasonder_get_SeaSondeAPM_SiteName <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$SiteName)
}

# Setter for SiteName
#' @export
seasonder_set_SeaSondeAPM_SiteName <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_SiteName(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_SiteOrigin <- function(seasonde_apm_obj) {
...
#' @export
seasonder_set_SeaSondeAPM_SiteOrigin <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_SiteOrigin(new_value)
  modified_obj <- seasonde_apm_obj
...
# Getter for FileName
#' @export
seasonder_get_SeaSondeAPM_FileName <- function(seasonde_apm_obj) {
...
# Setter for FileName
#' @export
seasonder_set_SeaSondeAPM_FileName <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_FileName(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_CreateTimeStamp <- function(seasonde_apm_obj) {
...
#' @export
seasonder_set_SeaSondeAPM_CreateTimeStamp <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_CreateTimeStamp(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_ProcessingSteps <- function(seasonde_apm_obj) {
...
#' @export
seasonder_set_SeaSondeAPM_ProcessingSteps <- function(seasonde_apm_obj, new_value,append=TRUE) {



  if(append){
    steps <-  seasonder_get_SeaSondeAPM_ProcessingSteps(seasonde_apm_obj)
    new_value <- c(steps,new_value)
  }
  validate_SeaSondeAPM_ProcessingSteps(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_AmplitudeFactors <- function(seasonde_apm_obj) {
...
#' @export
seasonder_set_SeaSondeAPM_AmplitudeFactors <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_AmplitudeFactors(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_AntennaBearing <- function(seasonde_apm_obj) {
...
#' @export
seasonder_set_SeaSondeAPM_AntennaBearing <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_AntennaBearing(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_StationCode <- function(seasonde_apm_obj) {
...
#' @export
seasonder_set_SeaSondeAPM_StationCode <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_StationCode(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_BearingResolution <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$BearingResolution)
}

# Setter for BearingResolution
#' @export
seasonder_set_SeaSondeAPM_BearingResolution <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_BearingResolution(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_Smoothing <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$Smoothing)
}

# Setter for Smoothing
#' @export
seasonder_set_SeaSondeAPM_Smoothing <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_Smoothing(new_value)
  modified_obj <- seasonde_apm_obj
...
#' @export
seasonder_get_SeaSondeAPM_CommentLine <- function(seasonde_apm_obj) {
  return(attributes(seasonde_apm_obj)$CommentLine)
}

# Setter for CommentLine
#' @export
seasonder_set_SeaSondeAPM_CommentLine <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_CommentLine(new_value)
  modified_obj <- seasonde_apm_obj
...
# Setter for FileID
#' @export
seasonder_set_SeaSondeAPM_FileID <- function(seasonde_apm_obj, new_value) {
  validate_SeaSondeAPM_FileID(new_value)
  modified_obj <- seasonde_apm_obj
...
# Getter for FileID
#' @export
seasonder_get_SeaSondeAPM_FileID <- function(seasonde_apm_obj) {
...
#' @param ... Additional arguments passed to the object creation function (See \code{\link{seasonder_createSeaSondeAPM}} for more details).
#' @return Returns a SeaSondeAPM object containing the parsed data.
#' @export
#' @importFrom magrittr %<>%
#' @seealso \code{\link{seasonder_createSeaSondeAPM}}
#' @seealso \code{\link{seasonder_validateAttributesSeaSondeAPM}}
seasonder_readSeaSondeAPMFile <- function(file_path,...) {
  ...
  out <- seasonder_createSeaSondeAPM(calibration_matrix = calibration_matrix,quality_matrix=quality_matrix,BEAR=BEAR,...)

  out <- seasonder_set_SeaSondeAPM_quality_matrix(out,new_value = quality_matrix)
  ...
  if (length(comment_lines) > 0) {
    ...
    setter_fun <- get("seasonder_set_SeaSondeAPM_CommentLine")
    out <- setter_fun(out, new_value = comment_str)
  }


  out <- seasonder_set_SeaSondeAPM_FileName(out,basename(file_path))


  out %<>% seasonder_set_SeaSondeAPM_ProcessingSteps(creation_step_text(file_path))

  # Validar los atributos después de la lectura
  seasonder_validateAttributesSeaSondeAPM(out)
